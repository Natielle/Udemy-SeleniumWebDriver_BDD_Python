# ESSE CÓDIGO NÃO FUNCIONA - NAO SEI PORQUEEEEE
# Locators organizados
# Utilização do teste através da classe e suas funcoes
# com espera explicita
# Manipulando Iframes através do webElement e dando zoom no mapa
...
class IframeSample:
    def __init__(self, driver):
        ...
        self.ZOOM = (By.CSS_SELECTOR, "button[aria-label=\"Acercar\"]")
    ...
    def expandir(self):
        ...
        driver.switch_to.frame("result")  # Muda de frame pelo index
        driver.switch_to.frame("Example2")
        # self.find(self.EXPANDIR).click()

        # Clica no ZOOM + 5 vezes
        #for x in range(0, 5):
        self.find(self.ZOOM).click()

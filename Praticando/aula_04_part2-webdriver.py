...
elem01 = driver.find_element(By.ID, "name123")
elem02 = driver.find_element(By.CLASS_NAME, "pass123")
elem03 = driver.find_element(By.CSS_SELECTOR, "button[class='form_submit'][type='submit']")
...
# driver.find_element(By.ID, "name123").send_keys("Natielle")
# driver.find_element(By.CLASS_NAME, "pass123").send_keys("minhasenha")
# driver.driver.find_element(By.CSS_SELECTOR, "button[class='form_submit'][type='submit']").click()

elem04 = driver.find_element(By.CSS_SELECTOR, "div.w3-border")
elem04 = elem04.text
